<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('assets/img/brand/hsp-logo2.png') }}" width="95" height="35" alt="Hasibuan Sumber Pancing">
        <img class="navbar-brand-minimized" src="{{ asset('assets/dw-01/img/brand/sygnet.svg') }}" width="30" height="30" alt="CoreUI Logo">
        <title>Hasibuan Sumber Pancing</title>
    </a>
