                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">
                                ...
                                <a href="{{ route('products.create') }}" class="btn btn-primary btn-sm float-right">Add</a>
                            </h4>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="{{ route('products.index') }}" method="get">
                                <div class="input-group mb-3 col-md-3 float-right">
                                    ...
                                    <input type="text" name="q" class="form-control" placeholder="Find..." value="{{ request()->q }}">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <img src="{{ asset('uploads/product/' . $row->image) }}" width="100px" height="100px" alt="{{ $row->name }}">
                                            </td>
                                            <td>
